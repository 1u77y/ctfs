...
* Executes `id` to simulate RCE output.
* Can be sent via `http://localhost/fetch?url=http%3A%2F%2Flocalhost%3A9000%2Frender/json` using post method to verify SSTI exploit viability.

---

This documentation provides a concise guide with clear enumeration scripts and a payload example to facilitate players through the Boot2Root CTF challenge from discovery to exploitation.
